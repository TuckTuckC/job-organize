...
import (
	...
	"libraries/gin-1.10.1/internal/bytesconv"
	"libraries/gin-1.10.1/render"
...
func (engine *Engine) Run(addr ...string) (err error) {
	...
	if engine.isUnsafeTrustedProxies() {
		debugPrint("[WARNING] You trusted all proxies, this is NOT safe. We recommend you to set a value.\n" +
			"Please check https://pkg.go.dev/libraries/gin-1.10.1#readme-don-t-trust-all-proxies for details.")
	}
...
func (engine *Engine) RunUnix(file string) (err error) {
	...
	if engine.isUnsafeTrustedProxies() {
		debugPrint("[WARNING] You trusted all proxies, this is NOT safe. We recommend you to set a value.\n" +
			"Please check https://libraries/gin-1.10.1/blob/master/docs/doc.md#dont-trust-all-proxies for details.")
	}
