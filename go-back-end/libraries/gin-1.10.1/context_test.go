...
import (
	...
	"libraries/gin-1.10.1/binding"
	testdata "libraries/gin-1.10.1/testdata/protoexample"
...
func TestContextHandlerName(t *testing.T) {
	...
	assert.Regexp(t, "^(.*/vendor/)?libraries/gin-1.10.1.handlerNameTest$", c.HandlerName())
}
