...
func TestListOfRoutes(t *testing.T) {
	...
	assertRoutePresent(t, list, RouteInfo{
		Method:  "GET",
		Path:    "/favicon.ico",
		Handler: "^(.*/vendor/)?libraries/gin-1.10.1.handlerTest1$",
	})
	assertRoutePresent(t, list, RouteInfo{
		Method:  "GET",
		Path:    "/",
	...
	assertRoutePresent(t, list, RouteInfo{
		Method:  "GET",
		Path:    "/users/",
		Handler: "^(.*/vendor/)?libraries/gin-1.10.1.handlerTest2$",
	})
	assertRoutePresent(t, list, RouteInfo{
		Method:  "GET",
		Path:    "/users/:id",
...
func TestNewOptionFunc(t *testing.T) {
	...
	routes := r.Routes()
	assertRoutePresent(t, routes, RouteInfo{Path: "/test1", Method: "GET", Handler: "libraries/gin-1.10.1.handlerTest1"})
	assertRoutePresent(t, routes, RouteInfo{Path: "/test2", Method: "GET", Handler: "libraries/gin-1.10.1.handlerTest2"})
}
